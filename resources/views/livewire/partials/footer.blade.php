    ...
    <div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 lg:pt-20 mx-auto">
        ...
        <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-5 gap-6">
            <div class="col-span-full lg:col-span-1">
                <a class="flex-none text-lg font-semibold text-white dark:focus:outline-none dark:focus:ring-1 dark:focus:ring-gray-600 flex flex-col items-center"
                    href="#" aria-label="Brand">
                    <img src="{{ asset('branding/techgear/techgear_logo_light.png') }}" class=""
                        alt="TechGear™ Logo">
                    <span class="text-wrap text-center">TechGear™ <br> Your Ultimate Tech Arsenal and Solution To PC Parts</span>
                </a>
            </div>
            <!-- End Col -->
        ...
        <div class="mt-5 sm:mt-12 grid gap-y-2 sm:gap-y-0 sm:flex sm:justify-between sm:items-center">
            <div class="flex justify-between items-center">
                <p class="text-sm text-gray-400">© {{ now()->year }} TechGear E-Commerce Website Development Team. All
                    Rights Are Reserved To Their Respective Owners.</p>
            </div>
            <!-- End Col -->
