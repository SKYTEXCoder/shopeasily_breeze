            ...
            <div class="grid md:grid-cols-2 gap-4 md:gap-8 xl:gap-20 md:items-center">
                <div>
                    <h1
                        ...
                        Start your journey with <span class="text-blue-600">ShopEasily™</span></h1>
                    <p class="mt-3 text-lg text-gray-800 dark:text-gray-400">Purchase wide varieties of electronic
                ...
                <div class="relative ms-4">
                    <img class="w-full rounded-md"
                        src="{{ asset("statics/vecteezy_3d-rendering-online-payment-for-ecommerce-or-online-shop_8508172.png") }}"
                        alt="Vecteezy 3D Rendering Online Payment For ECommerce Or Online Shop">
                    <div
