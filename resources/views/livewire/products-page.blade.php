            ...
            <div class="flex flex-wrap mb-24 -mx-3">
                <div class="w-full pr-2 lg:w-1/4 lg:block">
                        ...
                        <ul>
                            ...
                            <li class="mb-4">
                                <label for="in_stock" class="flex items-center dark:text-gray-300">
                                    <input type="checkbox" id="in_stock" value="1" wire:model.live="in_stock" class="w-4 h-4 mr-2">
                    ...
                    <div class="p-4 mb-5 bg-white border border-gray-200 dark:bg-gray-900 dark:border-gray-900">
                        ...
                        <div class="w-16 pb-2 mb-6 border-b border-rose-600 dark:border-gray-400"></div>
                        <div>
                            <div class="font-semibold">Harga Maksimum: {{ Number::currency($price_range, 'IDR', 'id') }}</div>
                            <input type="range" wire:model.live="price_range"
                                class="w-full h-1 mb-4 bg-blue-100 rounded appearance-none cursor-pointer"
                                max="{{ $max_price_of_queried_products }}" value="{{ $max_price_of_queried_products }}" step="5000">
                            <div class="flex justify-between ">
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency(0, 'IDR', 'id') }}</span>
                                <span class="inline-block text-lg font-bold text-blue-400 ">{{ Number::currency($max_price_of_queried_products, 'IDR', 'id') }}</span>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        @if (!$hasProducts)
                            <div class="w-full text-center py-16">
                                <span class="text-lg text-gray-500 dark:text-gray-400">
                                    There are currently no products matching your browse or search parameters in the system's database.
                                </span>
                            </div>
                        @else
                                ...
                                <div class="w-full px-3 mb-6 sm:w-1/2 md:w-1/3" wire:key="{{ $product->id }}">
                                    <div class="border border-gray-300 dark:border-gray-700">
                                        ...
                                        <div class="p-3 ">
                                            ...
                                            <p class="text-lg ">
                                                <span
                                                    class="text-green-600 dark:text-green-600">{{ Number::currency($product->final_price, 'IDR', 'id') }}</span>
                                            </p>
                                        </div>
